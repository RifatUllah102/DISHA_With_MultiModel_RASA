...
async def webhook(request):
    ...
    if(resposnse_text_dict[data['sender']][-1]=='আপনার চার ডিজিটের টি পিন নাম্বার বলুন' or resposnse_text_dict[data['sender']][-1]=='আপনার টি পিন নম্বরটি বলুন' or resposnse_text_dict[data['sender']][-1]=='স্যার, আপনার চার ডিজিটের টি পিন নম্বরটি বলুন'):
        print('changed text')
    ...
    try:
        ...
        if(len(response) > 0):
            ...
            if(response[0]['text']=='আপনার অ্যাকাউন্টের ব্যালেন্স হল এক লক্ষ ছয় হাজার টাকা'):
                if(data['cli']=='201'):
                    response[0]['text']='আপনার অ্যাকাউন্টের ব্যালেন্স হল দুই লক্ষ ছয় হাজার টাকা'
                if(data['cli']=='01713384891'):
                    response[0]['text']='আপনার অ্যাকাউন্টের ব্যালেন্স হল সত্তর লাখ পঁচাশি হাজার টাকা'
                if(data['cli']=='01714020387'):
                    response[0]['text']='আপনার অ্যাকাউন্টের ব্যালেন্স হল পঞ্চাশ লাখ পঁচাত্তর হাজার টাকা'
                if(data['cli']=='102'):
                    response[0]['text']='আপনার অ্যাকাউন্টের ব্যালেন্স হল নব্বই লাখ সাতষট্টি হাজার টাকা'
                if(data['cli']=='103'):
                    response[0]['text']='আপনার অ্যাকাউন্টের ব্যালেন্স হল ত্রিশ লক্ষ বিশ হাজার টাকা'
